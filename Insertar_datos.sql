...
VALUES
('1', 'Investigar nuevas tecnologías', '2024-05-20', '2024-05-31', 'Completado'),
('1', 'Realizar pruebas de simulación', '2024-06-17', '2024-06-24', 'Completado'),
('1', 'Presentar prototipo al cliente', '2024-09-30', '2024-09-30', 'Completado'),
('2', 'Solicitar información a la PUCP', '2024-11-04', '2024-11-11', 'Completado'),
('2', 'Reunión con el cliente', '2024-12-20', '2024-12-20', 'Pendiente'),
('3', 'Revisar la información de compras de ASUS', '2024-11-20', '2024-11-22', 'Cancelado'),
...
('4', 'Mostrar solución final al cliente', '2025-01-03', '2025-01-03', 'Pendiente'),
('5', 'Reunir información contable de VIVIENDA', '2024-05-20', '2024-05-31', 'Completado'),
...
('7', 'Reunir con el cliente para solicitar más información', '2024-12-02', '2024-12-04', 'Completado'),
('7', 'Administrar la primera etapa de mantenimiento de BD', '2025-01-06', '2025-01-14', 'Pendiente'),
('7', 'Elaborar un código en Python que automatice BD', '2024-12-06', '2024-12-13', 'Cancelado'),
...
VALUES
('Finalización las simulaciones', '2024-06-24', 'Completado', 'OK', '2'),
('Obtención de información de la PUCP', '2024-11-11', 'Completado', 'OK', '4'),
('Conclusión de la reunión con el cliente', '2024-12-20', 'Pendiente', '', '5'),
('Finalización la revisión de ASUS', '2024-11-22', 'Cancelado', 'El cliente se retiró', '6'),
('Cerrado de propuestas con el cliente', '2024-10-11', 'Completado', 'OK', '7'),
('Últimos pasos en las pruebas', '2024-12-20', 'Pendiente', '', '8'),
('Visto bueno del cliente', '2025-01-03', 'Pendiente', '', '9'),
('Finalización de la etapa de recibimiento de información', '2024-05-31', 'Completado', 'OK', '10'),
('Conclusión de la consolidación', '2024-06-25', 'Completado', '', '11'),
('Confirmación del cliente', '2024-07-31', 'Completado', 'El cliente resultó satisfecho', '12'),
('Finalización de la elaboración de prototipos', '2024-06-28', 'Cancelado',
	'El cliente no se reportaba', '13'),
('Indicaciones del cliente', '2024-12-04', 'Completado', 'El cliente brindó toda la información', '14'),
('Finalización de la primera etapa de mantenimiento', '2025-01-14', 'Pendiente', '', '15'),
('Presentación de la propuesta de automatización al cliente', '2024-12-16',
	'Cancelado', 'Problemas en la codificación', '16'),
('Finalización de la limpieza de datos de la BD', '2024-12-23', 'Pendiente', '', '17');
...
('8', '5', '2024-12-13', 'Líder'),

-- Proyecto 3
('11', '6', '2024-11-20', 'Participante'),
('20', '6', '2024-11-20', 'Líder'),
...
('2', '7', '2024-11-20 11:30:00', 'Se programó una reunión con la PUCP para resolver dudas técnicas.'),
('2', '8', '2024-12-15 14:10:00', 'Es necesario revisar las observaciones realizadas en la última auditoría.'),

-- Proyecto 3
('3', '20', '2024-11-21 09:45:00', 'El cliente canceló los servicios con la empresa.'),
    
-- Proyecto 4
('4', '10', '2024-10-10 10:00:00', 'El diseño del nuevo sistema de ciberseguridad ha sido aprobado.'),
('4', '6', '2024-11-01 16:20:00', 'Se detectaron vulnerabilidades en la red que deben ser resueltas.'),
('4', '14', '2024-12-05 14:50:00', 'Se completó la configuración inicial de los nuevos sistemas de seguridad.'),

-- Proyecto 5
('5', '12', '2024-06-01 09:15:00', 'El Ministerio solicitó una revisión del informe de asesorías.'),
('5', '15', '2024-07-15 11:40:00', 'Se completó la capacitación al equipo del Ministerio de Vivienda.'),
    
-- Proyecto 6
('6', '4', '2024-06-12 10:10:00', 'El cliente ha solicitado la cancelación del servicio.'),
    
-- Proyecto 7
('7', '19', '2024-12-03 08:50:00', 'Se configuraron las nuevas bases de datos para General Motors.'),
('7', '18', '2024-12-10 14:30:00', 'Es necesario ajustar el tamaño del almacenamiento de datos.'),
('7', '3', '2024-12-12 10:45:00', 'Se identificaron inconsistencias en los datos históricos.'),
('7', '3', '2024-12-13 15:55:00', 'Hubo problemas en codificar la propuesta de automatización.');
